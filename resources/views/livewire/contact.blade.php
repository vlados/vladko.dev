	...
	<div class="relative max-w-xl mx-auto">
		...
		<div class="text-center">
			...
			<p class="mt-4 text-lg leading-6 text-gray-500">
				Are you looking for a top-shelf full-stack web developer? Feel free to contact me if you have any
				questions, are interested in working together or just want to have a chat.
			</p>
		</div>
		<div class="mt-12">
