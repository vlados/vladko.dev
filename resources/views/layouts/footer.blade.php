...
<footer class="print:hidden">
    <div class="px-4 py-12 mx-auto overflow-hidden max-w-7xl sm:px-6 lg:px-8">
        <nav class="flex flex-wrap justify-center -mx-5 -my-2 space-x-7" aria-label="Footer">
            <a href="#about" class="text-gray-900 no-underline hover:text-indigo-700">About
                me</a>
            ...
            @if (isset($projects) && count($projects))
                <a href="#projects" class="text-gray-900 no-underline hover:text-indigo-700">Latest
                    projects</a>
            @endif
            <a href="#contact" class="text-gray-900 no-underline hover:text-indigo-700">Contact</a>
        </nav>
        <div class="flex flex-row justify-center mt-8 space-x-6">
