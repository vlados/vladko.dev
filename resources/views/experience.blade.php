<div class="container mx-auto py-16 lg:py-20 section print:mt-16    ">
    ...
    <div class="lg:grid lg:grid-cols-3 lg:gap-8">
        ...
        <div class="mt-12 lg:mt-0 lg:col-span-2">
            <div class="flow-root">
                <ul role="list" class="-mb-8 overflow-hidden">
                            ...
                            <div class="relative flex items-start space-x-3">
                                <div>
                                    <div class="relative px-1">
                                        <div
                                            class="h-7 w-7 bg-red-600 rounded-full ring-8 ring-white flex items-center justify-center">
                                            <x-icon class="fill-current text-white w-4 h-4" name="heart"></x-icon>
                                        </div>
                                    </div>
                                </div>
                                <div class="min-w-0 flex-1 ">
                  ...
                  <span class="absolute flex-shrink-0 flex items-center justify-center">
                    <span class="h-1.5 w-1.5 rounded-full bg-indigo-500" aria-hidden="true"></span>
                                                ...
                                                <span
                                                    class="ml-3.5 font-medium text-gray-900">Non-profit organization</span>
                                            </span>
                        ...
                        <div class="relative pb-8">
                            ...
                            <div class="relative flex items-start space-x-3">
                                <div class="relative">
                                    <x-image width="40" height="40"
                                             class="h-10 w-10 rounded-full bg-gray-400 flex items-center justify-center ring-8 ring-white"
                                             src="futuristlabs.jpg" alt="Futurist Labs"/>
                                </div>
                                <div class="min-w-0 flex-1">
                                    <div>
                                        <div class="text-lg leading-6 font-medium text-gray-900">
                        ...
                        <div class="relative pb-8">
                            ...
                            <div class="relative flex items-start space-x-3">
                                <div class="relative">
                                    <x-image width="40" height="40"
                                             class="h-10 w-10 rounded-full bg-gray-400 flex items-center justify-center ring-8 ring-white"
                                             src="storegecko.jpeg" alt="StoreGecko"/>
                                </div>
                                <div class="min-w-0 flex-1">
                                    <div>
                                        <div class="text-lg leading-6 font-medium text-gray-900">
